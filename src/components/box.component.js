...
class Box extends Component {
  ...
  // props: {num, id ,onDelete, onIncrement, onDecrement};
  constructor(props) {
    super(props);
  }
  ...
  render(){
    return ( 
          <div>
            <button type="button" className={this.state.className} onClick ={ this.decrement }  style ={ {color:"white"}} > Decrement </button>
